...
// Requête pour recupérer les infos de responsable de parcours
$sql0 = "SELECT * FROM responsables_parcours WHERE mat_res_parcour ";
            ...
            <ul>
                ...
                <li>
                    <a href="#" class="logo1">
                        ...
                        <h3 class="nav-item">Respo <span><?php echo $nomUSER; ?></span></h3>
                ...
                <li>
                    <div class="element">
                        ...
                        <div class="contenue">
                            ...
                            <a href="">
                                <span>Modifier info Etudiants</span>
                            </a>
                            <a href="../actions/liste_emplois_du_temps.php">
