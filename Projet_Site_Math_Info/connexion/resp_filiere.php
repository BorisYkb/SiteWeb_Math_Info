...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $sql0 = "SELECT * FROM responsables_filieres WHERE mat_res_filiere = $idUSER ";
            ...
            <ul>
                ...
                <li>
                    <a href="#" class="logo1">
                        ...
                        <h3 class="nav-item">MR <span><?php echo $nomUSER; ?></span></h3>
                ...
                <div class="element">
                        ...
                        <div class="contenue">
                            ...
                            <a href="../connexion/inscription_etudiant.php?id=<?php echo $idUSER; ?>">
                                <span>Enregistré Etudiants</span>
                            </a>
                ...
                <li>
                    <div class="element">
                        <div class="entete">
                            <i class='bx bx-store-alt'></i>
                            <h3>Emplois<span>du temps</span></h3>
                        </div>
                        <div class="contenue">
                            <a href="../actions/liste_emplois_du_temps.php?id=<?php echo $idUSER; ?>">
                                <span>Liste</span>
                            </a>
                            <a href="enregistrer_edt.php?id=<?php echo $idUSER; ?>">
                                <span>Enregistrer</span>
                            </a>
