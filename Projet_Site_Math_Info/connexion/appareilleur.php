...
$sql0 = "SELECT * FROM appareilleurs WHERE id_appareilleur ";
...
$sql1 = "SELECT COUNT(id_appareilleur) AS total FROM appareilleurs";
...
$sql = "SELECT COUNT(id_demande) AS total FROM demandes";
$resultat = mysqli_query($conn, $sql);
            ...
            <ul>
                ...
                <li>
                    <a href="#" class="logo1">
                        ...
                        <h3 class="nav-item">Appar. <span><?php echo $nomUSER; ?></span></h3>
        ...
        <section class="section1">
            ...
            <div class="start">
                ...
                <div class="card">
                    ...
                    <h3><?php echo $totalenseignant; ?><span> Appareilleurs</span></h3>
                    <p> enregistrés</p>
                </div>
                <div class="card">
            ...
            <section class="section2">
                ...
                <div class="recent">
                    <?php
                            ...
                            $sqlens = "SELECT * FROM salles ORDER BY id_salle DESC LIMIT 4";
                            $resultatens = mysqli_query($conn, $sqlens);

                            if ($resultatens && mysqli_num_rows($resultatens) > 0) {
                                echo '<h3 class="h3">Liste des <span>Salles</span></h3>';
                                echo '<table>';
                                echo '<thead><tr><th>Nom</th><th>Capacité</th><th>Statut</th></tr></thead>';
                                echo '<tbody>';
                                ...
                                while ($row=$resultatens->fetch_assoc()) {
                                    ...
                                    echo '<tr><td>' . $nom_sa . '</td><td>' . $capacite . '</td><td>' . $statut . '</td></tr>';
                                ...
                                echo '<p>Aucune Salle enregistrée.</p>';
                            }
                ...
                <div class="footer">
                    <a href="../actions/liste_salle.php">Plus</a>
                </div>
