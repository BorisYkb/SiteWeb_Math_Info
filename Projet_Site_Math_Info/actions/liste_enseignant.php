    ...
    <div class="contenue">
        ...
        <?php if ($niveauUSER == 4 or $niveauUSER == 5) { ?>
                <div class="addmember1">
                    <a href="../connexion/inscription_enseignant.php?id=<?php echo $niveauUSER; ?>" class="addmember">
                        <div><i class='bx bx-store-alt'></i></div>
                        <h4>Ajouter</h4>
                    </a>
                </div>
        <?php } ?>
            ...
            <table>
                ...
                <tbody>
                    <?php
                        ...
                        $req = "SELECT * FROM enseignants ORDER BY id_enseignant";
                ...
                <tfoot>
                    <tr>
                        <td colspan="6">
                            <caption>
                                <h3>Liste des <span>Etudiants</span></h3>
                            </caption>
