...
<head>
    ...
    <title>Articles & Mémoire | MI</title>
    ...
    <div class="contenue">
        ...
        <div class="tablemember">
            <div class="addmember1">
                <a href="../connexion/cours_td.php" class="addmember">
            ...
            <table>
                ...
                <tbody>
                    <?php
                        ...
                        $req = "SELECT * FROM documents ORDER BY id_doc";
                    ...
                    <tr>
                        ...
                        <td><a href='download_article.php?id=" . $row["id_doc"] . "' class='detail'>Télécharger</a></td>
                    </tr>
                        ";
                           }
                    ?>
                ...
                <tfoot>
                    <tr>
                        <td colspan="6">
                            <caption>
                                <h3>Liste des <span>Articles & Mémoires</span></h3>
                            </caption>
                        </td>
                    </tr>
                </tfoot>
