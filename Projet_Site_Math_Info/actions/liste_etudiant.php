...
<head>
    ...
    <title>Liste des Etudiants | MI</title>
...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $sql0 = "SELECT * FROM utilisateur WHERE matricule_user = '$idUSER'";
    ...
    if ($resultatUSER && mysqli_num_rows($resultatUSER) > 0) {
        ...
        $niveauUSER = htmlspecialchars($USER['niveau_user']);
...
?>
    ...
    * {
    ...
    <div class="contenue">
        ...
        <?php if ($niveauUSER == 4 or $niveauUSER == 5) { ?>
                <div class="addmember1">
                    <a href="../connexion/inscription_etudiant.php?id=<?php echo $niveauUSER; ?>" class="addmember">
            ...
            <table>
                ...
                <tbody>
                    <?php
                        ...
                        $req = "SELECT * FROM etudiants ORDER BY matetu";
                ...
                <tfoot>
                    <tr>
                        <td colspan="6">
                            <caption>
                                <h3>Liste des <span>Etudiants de la classe</span></h3>
                            </caption>
