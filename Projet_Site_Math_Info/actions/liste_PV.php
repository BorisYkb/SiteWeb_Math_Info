    ...
    <div class="contenue">
        ...
        <div class="tablemember">
            ...
            <table>
                ...
                <tbody>
                    <?php
                        $req = "SELECT * FROM pv ORDER BY id_pv";
                        ...
                        while($row=$resultat->fetch_assoc()){
                            echo "
                    <tr>
                        <th>$row[niveau_etude]</th>
                        <td>$row[annee_uni]</td>
                        <td>$row[id_filiere]</td>
                        <td>$row[specialite]</td>
                        <td>$row[detail]</td>
                        <td>
                                            <a href='download_pv.php?id=" . $row["id_pv"] . "' class='detail'>Télécharger</a>
                                            <a class='production' href='modSupCT.php?id=$row[id_pv]'>Détail</a>
                                        </td>
                    </tr>
                        ";
                           }
