...
<head>
    ...
    <title>Liste des Demandes | MI</title>
...
<body>
    ...
    * {
    ...
    <header>
        ...
        <a href="../connexion/secretaire.php?id=<?php echo $idUSER; ?>" class="list">Tableau de Borde</a>
    </header>
            ...
            <table>
                ...
                <tbody>
                    <?php
                        ...
                        $req = "SELECT * FROM demandes ORDER BY id_demande";
                    ...
                    <tr>
                        ...
                        <td>
                                          <a class='production' href='detailDemande.php?id=$row[id_demande]'>Détail</a>
                                        </td>
                ...
                <tfoot>
                    <tr>
                        <td colspan="6">
                            <caption>
                                <h3>Liste des <span>Demandes</span></h3>
                            </caption>
                        </td>
                    </tr>
                </tfoot>
